const judgeProfileImages = [
    ...
    "brennanhatton_profile_picture_of_judge_gpt_ai_judge_old_genderl_0b9e7c16-63b0-4a9d-bf59-61851d07b4ea.png"/*,//this one
...
class BackgroundImages
{
    ...
    static async SetBackground()
    {
        ...
        var imageLoadPromise = new Promise((resolve, reject) => {
            img.onload = resolve;
            img.onerror = reject;
            img.src = 'https://brennan.games/JudgeGPT//images/' + bgImage;
        });
